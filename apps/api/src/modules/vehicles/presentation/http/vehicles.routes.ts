...
export async function vehiclesRoutes(app: FastifyInstance) {
  ...
  app.get('/:id', {
    schema: {
      ...
      summary: 'Get vehicle',
      description: 'Returns a single vehicle by id for the authenticated user.',
      security: [{ cookieAuth: [] }],
  ...
  app.delete('/:id', {
    schema: {
      ...
      description: 'Deletes a vehicle by id for the authenticated user.',
      security: [{ cookieAuth: [] }],
      params: toOpenApiSchema(vehicleIdParamsSchema),
      response: {
        204: {
  ...
  app.patch('/:id', {
    schema: {
      ...
      description: 'Updates selected fields for a vehicle owned by the authenticated user.',
      security: [{ cookieAuth: [] }],
      params: toOpenApiSchema(vehicleIdParamsSchema),
