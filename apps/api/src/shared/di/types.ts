...
import type { DocumentLogRepository } from '../../modules/documents-log/contracts/document-log.repository';
import type { VehicleRepository } from '../../modules/vehicles/contracts/vehicle.repository';
